...
/*here we can define the custom password instead of spring generated password
 *
 *
 * */
...
public class CustomerUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        //if (role == null) role = USER_ROLE.ROLE_CUSTOMER; // if user dosent mention any role then a customer
